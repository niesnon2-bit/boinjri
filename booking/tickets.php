...
<head>
    ...
    <style>
        ...
        .date-card.active {
            ...
            color: #fff;
            border-color: #8a7048;
            box-shadow: 0 4px 14px rgb(166 139 90 / 0.45);
        }
...
<header class="bg-white border-b py-6">
    <div class="container mx-auto px-4">
        ...
        <p class="mt-2"><a href="<?php echo h(url('index.php')); ?>" class="text-amber-800 text-sm">← الرئيسية</a></p>
    </div>
</header>
            ...
            <div class="p-8 space-y-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <div class="mt-2 text-sm text-gray-500">السعر <span class="font-bold text-amber-700">50.00 ريال</span></div>
                    </div>
                    <div class="flex flex-col items-end gap-1">
                        <p class="text-xs text-slate-500">حد أقصى <span class="font-bold text-slate-700">12</span> تذكرة</p>
                ...
                <div class="flex justify-between items-center text-lg font-bold">
                    <span>الإجمالي</span>
                    <span id="totalPrice">50 ريال</span>
                </div>
            </div>
        </div>
...
function updateQty(delta) {
    ...
    if (newQty > maxTickets) newQty = maxTickets;
    currentQty = newQty;
    document.getElementById("ticketQty").innerText = currentQty;
    document.getElementById("qtyInput").value = currentQty;
    document.getElementById("totalPrice").innerText = (currentQty * ticketPrice).toFixed(2) + " ريال";
}
